...
CPP_SRCS += \
../Core/Src/json/jsonConfigHandler.cpp 

OBJS += \
./Core/Src/json/jsonConfigHandler.o 

CPP_DEPS += \
./Core/Src/json/jsonConfigHandler.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/json/%.o Core/Src/json/%.su Core/Src/json/%.cyclo: ../Core/Src/json/%.cpp Core/Src/json/subdir.mk
...
clean: clean-Core-2f-Src-2f-json

clean-Core-2f-Src-2f-json:
	-$(RM) ./Core/Src/json/jsonConfigHandler.cyclo ./Core/Src/json/jsonConfigHandler.d ./Core/Src/json/jsonConfigHandler.o ./Core/Src/json/jsonConfigHandler.su

.PHONY: clean-Core-2f-Src-2f-json
