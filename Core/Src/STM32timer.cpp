...
#include "thread/timerInterrupt.h"
#include "thread/pruThread.h"

STM32timer::STM32timer(TIM_TypeDef* _timer, IRQn_Type _irq, uint32_t _frequency, pruThread* _ownerPtr, int _irqPriority)
